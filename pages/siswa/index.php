...
<div class="card">
    ...
    <div class="table-responsive">
        <table>
            <thead><tr><th>No</th><th>Kode</th><th>Nama</th><th>NIS</th><th>No HP</th><th>Jenis Kelamin</th><?php if (can_manage_master()): ?><th>Aksi</th><?php endif; ?></tr></thead>
            <tbody>
            <?php foreach ($siswa as $i => $row): ?>
                <tr>
                    <td><?= $i + 1 ?></td><td><?= e($row['kode_siswa']) ?></td><td><?= e($row['nama_siswa']) ?></td><td><?= e($row['nis']) ?></td><td><?= e($row['no_handphone']) ?></td><td><?= e($row['jenis_kelamin']) ?></td>
            ...
            <?php endforeach; ?>
            <?php if (!$siswa): ?><tr><td colspan="7" class="text-center">Data tidak ditemukan.</td></tr><?php endif; ?>
            </tbody>
        </table>
    </div>
</div>
